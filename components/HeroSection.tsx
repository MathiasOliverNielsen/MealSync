const HeroSection = () => (
  <section className="bg-gray-50 py-12 px-4 flex flex-col items-center">
    <div className="max-w-2xl text-center">
      ...
      <p className="text-gray-600 mb-6">Choose a dish, and we'll build your shopping list. Meal planning made easy and efficient.</p>
    ...
    <div className="mt-10 w-full flex justify-center">
      <div className="bg-gray-200 w-80 h-40 flex items-center justify-center rounded shadow-inner">
